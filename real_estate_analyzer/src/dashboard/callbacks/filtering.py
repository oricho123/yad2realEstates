...
class FilterCallbackManager:
    ...
    def _register_filter_update_callback(self) -> None:
        ...
        @self.app.callback(
            [Output('price-range-slider', 'min'),
             ...
             Output('floor-range-slider', 'min'),
             Output('floor-range-slider', 'max'),
             Output('floor-range-slider', 'value'),
             Output('floor-range-slider', 'marks'),
        ...
        def update_filter_ranges(current_data):
            ...
            try:
                ...
                clean_df = df.dropna(
                    subset=['price', 'square_meters', 'rooms'])
                ...
                return (
                    ...
                    # Floor range slider
                    filter_options['floor_min'],
                    filter_options['floor_max'],
                    [filter_options['floor_min'], filter_options['floor_max']],
                    filter_options['floor_marks'],
    ...
    def _get_empty_filter_config(self) -> Tuple:
        ...
        return (
            # Price range slider
            0, 5000000, [0, 5000000], NumberFormatter.create_price_marks(
                0, 5000000, num_marks=3),

            # Square meters range slider
            0, 500, [0, 500], NumberFormatter.create_number_marks(
                0, 500, num_marks=3, suffix="m²"),
