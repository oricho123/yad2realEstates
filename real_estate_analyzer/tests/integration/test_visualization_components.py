...
def test_map_view():
    ...
    assert summary['total_properties'] == len(
        test_data), "Should have correct property count"
...
def test_chart_factory():
    ...
    assert deps['total_properties'] == len(
        test_data), "Should report correct property count"
...
def test_chart_utils():
    ...
    assert len(street_display) == len(
        test_data), "Should have same length as data"
